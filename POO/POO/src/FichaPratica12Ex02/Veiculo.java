...
import FichaPratica12Ex02.TipoDeCombustivel;
...
public class Veiculo {
  ...
  public Veiculo(String marca, String modelo, int anoFabrico, int potencia, double cilindrada, TipoDeCombustivel tipoDeCombustivel, double consumo) {
    this.marca = marca;
    this.modelo = modelo;
  ...
  public double consumo(double distacia){
    double consumoTotal=0;

    consumoTotal = (this.consumo/100)*distacia; // (this.consumo/100) litros consumidos a cada Km
